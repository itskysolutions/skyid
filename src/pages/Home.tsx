...
export const Home = () => {
  ...
  return (
    <div style={{minHeight: "100vh", display: "flex", flexDirection:"column", minWidth: "100%"}}>
        <Header/>
        <div className='main-content items-center justify-center py-20 flex flex-grow'>
            ...
            <div 
                ...
                <div className='' style={{marginTop: "100px"}}>
                    <h1 className="text-center mb-4" style={{textDecoration: 'bold', fontSize: '60px'}}>Your Business, One Number, <br/> Endless Possibilities</h1>
                    <p className="text-center" style={{color: '#5b5b5b', fontSize: '20px'}}>Sky ID offers businesses a unique 0700 toll number that can map multiple lines, 
                        ensuring that <br/> your business is always available with an easy-to-remember number 
                        without displaying <br/> numerous contact numbers.
                    </p>
            ...
            <div className="container mt-5" style={{ marginTop: '30%', paddingTop: '25%', width: '100%', maxWidth: '1000px'}}>
                {/**Features section */}
                <div id="features" className="pt-4 mt-10">
                    <div className="">
                        <h1 className="text-3xl md:text-5xl font-bold mb-6">
                        SKY ID, ENSURING YOU ARE <br /> REACHABLE ANYTIME, <br /> ANYWHERE...
                        </h1>
                        <p className="text-lg text-gray-600 mb-8">
                        Call mapping is the process of masking/hiding/mapping phone numbers behind a 0700 <br /> 
                        number. I.e. a business can have a 0700 number and decide to mask his <br />
                        number and his employee’s number behind the 0700 number.
                        </p>
                    </div>
                    <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2" style={{paddingTop:'5%', paddingBottom:'10%'}}>
                        <Card style={{background: "#04D02A0F", border:'none' , width: 'auto', maxWidth: '1000px', height:'auto', maxHeight:'705px'}}>
                            <Card.Body>
                                <Card.Title >
                                    <h2 className="text-2xl font-semibold ps-4 pt-3" style={{color:'#333333'}}>Key Features</h2>
                                    <table>
                                        <tbody>
                                            <tr>
                                                 <td>
                                                    <Card style={{border:'none'}}>
                                                        <Card.Body style={{ backgroundColor: "#04D02A0F"}}>
                                                            <Card style={{border:'none'}}>
                                                                <Card.Body style={{ backgroundColor: "#04D02A0F"}}>
                                                                    <svg style={{paddingRight: "10px"}} width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Contact Icon">
                                                                    ...
                                                                    <Card.Text className='text-gray-600'>
                                                                        <p style={{color: '#5b5b5b', fontSize: '18px'}}>Simplify customer experience by using a single 0700 number for all your team members.</p>
                                                                    </Card.Text>
                                                                </Card.Body>
                                                            </Card>
                                                            <Card style={{border:'none'}}>
                                                                <Card.Body style={{ backgroundColor: "#04D02A0F"}}>
                                                                    ...
                                                                    <Card.Text>
                                                                        <p style={{color: '#5b5b5b', fontSize: '18px'}}>Customers can always reach you, improving retention and satisfaction.</p>
                                                                    </Card.Text>
                                                                </Card.Body>
                                                            </Card>
                                                            <Card style={{border:'none'}}>
                                                                <Card.Body style={{ backgroundColor: "#04D02A0F"}}>
                                                                    ...
                                                                    <Card.Text>
                                                                        <p style={{color: '#5b5b5b', fontSize: '18px'}}>Stand out with a recognizable number that reinforces your brand</p>
                                                                    </Card.Text>
                                                                </Card.Body>
                                                            </Card>
                                                        </Card.Body>
                                                ...
                                                <td>
                                                    <Card style={{border:'none'}}>
                                                         <Card.Body style={{ backgroundColor: "#04D02A0F"}}>
                                                            <Card style={{border:'none'}}>
                                                                <Card.Body className='pb-3' style={{ backgroundColor: "#04D02A0F"}}>
                                                                    <svg style={{paddingRight: "10px"}} width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Contact Icon">
                                                                        <path fillRule="evenodd" clipRule="evenodd" d="M9.84417 3.10743C11.026 1.89713 12.9725 1.89713 14.1543 3.10743L14.8049 3.77372C15.0747 4.05001 15.4458 4.20376 15.832 4.19916L16.7632 4.18807C18.4546 4.16792 19.831 5.5443 19.8109 7.23577L19.7998 8.16695C19.7952 8.55309 19.9489 8.92426 20.2252 9.19406L20.8915 9.84465C22.1018 11.0265 22.1018 12.973 20.8915 14.1548L20.2252 14.8054C19.9489 15.0751 19.7952 15.4463 19.7998 15.8325L19.8109 16.7636C19.831 18.4551 18.4546 19.8315 16.7632 19.8113L15.832 19.8003C15.4458 19.7957 15.0747 19.9494 14.8049 20.2257L14.1543 20.892C12.9725 22.1023 11.026 22.1023 9.84417 20.892L9.19357 20.2257C8.92378 19.9494 8.5526 19.7957 8.16646 19.8003L7.23528 19.8113C5.54381 19.8315 4.16743 18.4551 4.18758 16.7636L4.19867 15.8325C4.20327 15.4463 4.04952 15.0751 3.77323 14.8054L3.10694 14.1548C1.89664 12.973 1.89664 11.0265 3.10694 9.84465L3.77323 9.19405C4.04952 8.92426 4.20327 8.55309 4.19867 8.16695L4.18758 7.23577C4.16743 5.5443 5.54381 4.16792 7.23528 4.18807L8.16646 4.19916C8.5526 4.20376 8.92378 4.05001 9.19357 3.77372L9.84417 3.10743ZM15.6256 10.6252C15.9381 10.3128 15.9381 9.80622 15.6256 9.4938C15.3132 9.18138 14.8067 9.18138 14.4943 9.4938L11.482 12.5061C11.2775 12.7105 11.1526 12.8339 11.0591 12.9137C10.9656 12.8339 10.8406 12.7105 10.6362 12.5061L9.56482 11.4347C9.2524 11.1223 8.74586 11.1223 8.43344 11.4347C8.12103 11.7471 8.12103 12.2537 8.43345 12.5661L9.53408 13.6667C9.74144 13.8742 9.94954 14.0824 10.1457 14.2321C10.3696 14.4029 10.6691 14.5708 11.0591 14.5708C11.4491 14.5708 11.7486 14.4029 11.9725 14.2321C12.1686 14.0824 12.3767 13.8742 12.5841 13.6667L15.6256 10.6252Z" fill="green"></path>
                                                                    </svg>
                                                                    <Card.Title>
                                                                    ...
                                                                    <Card.Text className='pb-2'>
                                                                        <p style={{color: '#5b5b5b', fontSize: '18px'}}>Our call mapping technology ensures calls are directed to the next available line without hassle.</p>
                                                                    </Card.Text>
                                                                </Card.Body>
                                                            </Card>
                                                            <Card style={{border:'none'}}>
                ...
                <div style={{marginBottom: '100px'}}>
                    <div style={{marginTop: '60px', marginBottom:'30px'}}>
                        ...
                        <p style={{marginTop: "20px" ,color: '#5b5b5b', fontSize: '18px'}}>
                            ...
                            the system routes the call to primary <br/> contact. If the primary number is unavailable , 
                            the system intelligently redirects the call to the next available team <br/> member.
                        </p>
                        <Button 
                            className="me-3 px-4 py-3 rounded-md" 
                            style={{ 
                        ...
                        <div style={{marginTop: '40px', marginBottom:'150px'}}>
                            <Image 
                                ...
                                style={{ 
                                width: 'auto',
                                maxWidth:'1059px', // Adjust size as needed
                                height: '466px',
                            }} rounded/>
                        </div>
                    </div>
                ...
                {/**Use case section */}
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td >
                                            <div>
                                                <Card style={{ padding:'',width: 'auto',maxWidth:'320px', height:'auto',maxHeight:'414px', backgroundColor:"#ffffff" ,border: 'none', boxShadow: '0 10px 30px -12px rgba(0,0,0.1)'}}>
                                                    <Card.Body>
                                                        ...
                                                        <Card.Title className='text-center'style={{color: "#333333"}}>Customer Service <br/> Optimization</Card.Title>
                                                        <Card.Text className='text-center' style={{color: '#5b5b5b', marginTop: "20px", fontSize:'18px'}}>
                                                            Businesses can use SKY ID to provide better customer service  by 
                                                            ensuring no calls are missed and employees are reachable without displaying personal numbers.
                                                        </Card.Text>
                                                    </Card.Body>
                                                </Card> 
                                            </div>
                                        ...
                                        <td >
                                             <div style={{marginLeft:"20px"}}>
                                                <Card style={{paddingBottom:'17%', width: 'auto',maxWidth:'320px', height:'auto',maxHeight:'414px', backgroundColor:"#ffffff" ,border: 'none', boxShadow: '0 10px 30px -12px rgba(0,0,0.1)' }}>
                                                    <Card.Body>
                                                        <div className='d-flex justify-content-center align-items-center circle-container container' >
                                        ...
                                        <td >
                                            <div style={{marginLeft:"20px"}}>
                                                <Card style={{ paddingBottom:'25%',width: 'auto',maxWidth:'320px', height:'auto', maxHeight:'414px',  backgroundColor:"#ffffff" ,border: 'none', boxShadow: '0 10px 30px -12px rgba(0,0,0.1)'}}>
                                                    <Card.Body>
                                                        <div className='d-flex justify-content-center align-items-center circle-container container' >
                                                            <div className='circle'>
                                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='container' style={{marginBottom: '100px'}}>
                        <Card style={{ width: '1000px', height:'434px', backgroundColor:"#D92027"}}>
                            <Card.Body>
                                <Card.Title style={{color: 'white', fontSize:"44px", margin: "40px"}} className=''>Why Choose Sky ID</Card.Title>
                                <table className='d-flex justify-content-center' style={{marginTop:"50px"}}>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <Card style={{width: '100%', height:'100%', backgroundColor:"#D92027", border: 'none'}}>
                                                    <Card.Body>
                                                        ...
                                                        <Card.Title style={{color:"white"}} className='r'>Always Reachable</Card.Title>
                                                        <Card.Text className='' style={{color: 'white', marginTop: "20px"}}>
                                                            Customers enjoy reliable access, <br/> 
                                                            and businesses experience <br/> increased sales.
                                                        </Card.Text>
                                                    </Card.Body>
                                                </Card>
                                            </td>
                                            <td>
                                                <Card style={{marginLeft:"40px", height: '100%', backgroundColor:"#D92027", border: 'none'}}>
                                                    <Card.Body>
                                                        <svg style={{marginBottom: '10%'}} width="52" height="52" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M10.9294 13.9106C10.9294 13.9106 10.9322 13.9093 10.9368 13.9086C10.9316 13.9106 10.9294 13.9106 10.9294 13.9106Z" fill="#ffffff" className="my-path"></path>
                                                            <path d="M10.9565 13.9086C10.9611 13.9093 10.9639 13.9106 10.9639 13.9106C10.9639 13.9106 10.9617 13.9106 10.9565 13.9086Z" fill="#ffffff" className="my-path"></path>
                                                        ...
                                                        <Card.Text className='' style={{color: 'white', marginTop: "20px" }}>
                                                            Link multiple numbers to one line <br/> 
                                                            providing flexible distribution of <br/> calls based on availability.
                                                        </Card.Text>
                                                    </Card.Body>
                                                </Card>
                                            </td>
                                            <td>
                                                <Card style={{marginLeft:"40px", height: "100%", backgroundColor:"#D92027",  border: 'none'}}>
                                                    <Card.Body>
                                                        ...
                                                        <Card.Text className='' style={{color: 'white', marginTop: "20px"}}>
                                                            Enhance your service with options <br/> 
                                                            like Interactive Voice Response, <br/> Call center Solutions, and Virtual <br/>
                                                            PBX.
                                                        </Card.Text>
                                                    </Card.Body>
                                                </Card>
                    ...
                    {/** Pricing */}
                    <div id='pricing' style={{marginBottom: '70px', paddingTop: '9%'}} className='container'>
                        <div className='text-center'>
                            <h1 style={{fontSize:"60px", paddingRight: "15%" }}>Choose the Plan for You</h1>
                        </div>
                        <div className='d-flex justify-content-center' style={{marginTop:"2%"}}>
                            <p style={{textAlign: 'center', fontSize:'18px', color: '#5b5b5b', paddingRight: "15%"}}>Choose the right plan for your team with affordable rates and flexible options, <br/>
                                so you're always reachable</p>
                        </div>
                        <div className='d-flex justify-content-center' style={{paddingRight: "15%"}}>
                        ...
                        <div className='d-flex justify-content-center' style={{marginTop:'3%', paddingRight: "15%"}}>
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <Card style={{height: "435px", width:'349px', border: "2px solid #D92027", borderRadius: "8px"}}>
                                                <Card.Body className="d-flex flex-column h-100">
                                                    ...
                                                    <Card.Title style={{fontSize:'18px', color: '#5b5b5b', paddingBottom:'5%',  paddingLeft: '3%'}}><svg style={{paddingRight: '3%'}}width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M12 7L12 13" stroke="#000000" stroke-width="1.6" stroke-linecap="round" className="my-path"></path>
                                                        <path d="M11.9992 15.9414L11.9492 15.9414" stroke="#000000" stroke-width="1.6" stroke-linecap="round" className="my-path"></path>
                                                        <path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#000000" stroke-width="1.6" className="my-path"></path>
                                                    </svg>Add-Ons priced separately</Card.Title>
                                                    <Card.Text>
                                                        <ul style={{fontSize:'18px', color: '#5b5b5b', paddingBottom:'3%'}}>
                                                            <li style={{paddingBottom:'4%'}}>Interactive Voice Response</li>
                                                            <li style={{paddingBottom:'4%'}}>Call Center Solutions</li>
                                                            <li style={{paddingBottom:'4%'}}>Virtual PBX</li>
                                                        </ul>
                                                    </Card.Text>
                                        ...
                                        <td>
                                            <Card style={{marginLeft:"15%", height: "435px", width:'349px', border: "2px solid #D92027", borderRadius: "8px"}}>
                                                <Card.Body className="d-flex flex-column h-100">
                    ...
                    {/** FAQ */}
                     <div className='container' id='faqs' style={{marginBottom: '100px', paddingTop: '10%'}}>
                        ...
                        <div className='' style={{marginTop:"2%", paddingRight: "15%"}}>
