      ...
      <div>
        ...
        >
          <div className="" style={{ marginTop: "100px" }}>
            <h1 className="text-center mb-4" style={{ textDecoration: "bold", fontSize: "60px" }}>
              My Identity, My Availability
            </h1>
        ...
        <div
          ...
          style={{ marginTop: "50%", paddingTop: "25%", width: "auto", maxWidth: "1000px" }}
        >
          <div className="" style={{}}>
            <div className="pt-5">
              <h1
              ...
              <p
                ...
                style={{ width: "auto", height: "auto", maxWidth: "650px", maxHeight: "81px" }}
              >
                Call mapping is the process of masking/hiding/mapping phone numbers behind a 0700 number. I.e. a
                business can have a 0700 number and decide to mask his number and his employee’s number behind the 0700
                number.
              </p>
            </div>
            {/**Features section */}
                                ...
                                <Card.Body style={{ backgroundColor: "#04D02A0F" }}>
                                  ...
                                  <div className="d-flex align-items-start">
                                    <div className="">
                                      ...
                                      <Card.Text style={{ color: "#5b5b5b", fontSize: "18px" }}>
                                        Our call mapping technology ensures calls are directed to the next available
                                        line without hassle
                                      </Card.Text>
                                    </div>
                                  </div>
            ...
            <Card style={{ border: "none", width: "auto", maxWidth: "1000px", height: "auto", maxHeight: "100%" }}>
              <Card.Body style={{ background: "#515151", borderRadius: "20px" }}>
                <Card.Title className="text-2xl font-semibold" style={{ color: "white" }}>
                  <h2 className="text-2xl font-semibold ps-4 pt-3" style={{ color: "white" }}>
                    Additional Features
                  </h2>
                </Card.Title>
                <Row className="gx-4 gy-4">
                              ...
                              <Card.Body style={{ backgroundColor: "#515151" }}>
                                <div className="d-flex align-items-start">
                                  <div className="">
                                    ...
                                    <Card.Text style={{ color: "white", fontSize: "18px" }}>
                                      <b>Example:</b> When a customer calls a textile shop, they hear, “Thank you for
                                      calling ABC Textiles! Press 1 for new orders, press 2 for delivery inquiries, or
                                      press 3 to speak with a sales representative.” This way, customers can quickly get
                                      connected to the right person based on their needs, keeping operations smooth even
                                      during busy times.
                                    </Card.Text>
                                  </div>
                                </div>
                            ...
                            <Card style={{ border: "none" }}>
                              <Card.Body style={{ backgroundColor: "#515151" }}>
                                <div className="d-flex align-items-start">
                                  <div className="">
                                    <Card.Title style={{ color: "white" }}>
                                      2. Integrated Voice Messaging (IVM)
                                    </Card.Title>
                                    <Card.Text style={{ color: "white", fontSize: "18px" }}>
                                    ...
                                    <Card.Text style={{ color: "white", fontSize: "18px" }}>
                                      <b>Example:</b> A textile shop uses IVM to keep callers informed if there’s a
                                      delay in answering. When a customer calls during peak hours and no one is
                                      available, they hear, “Thank you for calling! We will be with you shortly. Did you
                                      know our new fabric line is 10% off this month?” This helps keep customers engaged
                                      and informed, even while they wait.
                                    </Card.Text>
                                  </div>
                                </div>
                              </Card.Body>
                ...
                <Col xs={12} md={4}>
                  <Card
                    style={{
                      ...
                      border: "none",
                      boxShadow: "0 15px 50px -12px #0000001C",
                      borderRadius: "20px",
                    }}
                  >
                    <Card.Body>
                      <div className="d-flex justify-content-center align-items-center circle-container container">
                        <div className="circle">
                          ...
                          >
                            <path
                              d="M5.49971 9.2001C3.67717 9.2001 2.19971 10.6776 2.19971 12.5001V13.5001C2.19971 15.3226 3.67717 16.8001 5.49971 16.8001C7.32225 16.8001 8.79971 15.3226 8.79971 13.5001V12.5001C8.79971 10.6776 7.32225 9.2001 5.49971 9.2001Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M18.4997 16.7997C20.3222 16.7997 21.7997 15.3222 21.7997 13.4997V12.4997C21.7997 10.6772 20.3222 9.19971 18.4997 9.19971C16.6772 9.19971 15.1997 10.6772 15.1997 12.4997V13.4997C15.1997 15.3222 16.6772 16.7997 18.4997 16.7997Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M12 21.7999C12.9941 21.7999 13.8 20.994 13.8 19.9999C13.8 19.0058 12.9941 18.1999 12 18.1999C11.0059 18.1999 10.2 19.0058 10.2 19.9999C10.2 20.994 11.0059 21.7999 12 21.7999Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M5.19976 8.99971C5.19976 5.24417 8.24422 2.19971 11.9998 2.19971C15.7553 2.19971 18.7998 5.24417 18.7998 8.99971V9.99971H17.1998V8.99971C17.1998 6.12783 14.8716 3.79971 11.9998 3.79971C9.12788 3.79971 6.79976 6.12783 6.79976 8.99971V9.99971H5.19976V8.99971Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M18.8001 15.9998C18.8001 18.6508 16.6511 20.7998 14.0001 20.7998H13.0001V19.1998H14.0001C15.7674 19.1998 17.2001 17.7671 17.2001 15.9998H18.8001Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                          </svg>
                      ...
                      <Card.Title className="text-center" style={{ color: "#333333" }}>
                        Customer Service Optimization
                      </Card.Title>
                      <Card.Text
                        className="text-center"
                        style={{ color: "#5b5b5b", marginTop: "20px", fontSize: "18px" }}
                      >
                        Keep customer service seamless by ensuring that calls are always answered without exposing
                        personal numbers.
                      </Card.Text>
                    </Card.Body>
                  </Card>
                    ...
                    <Card.Body>
                      <div className="d-flex justify-content-center align-items-center circle-container container">
                        <div className="circle">
                          ...
                          >
                            <path
                              d="M18.3085 20.8002C18.3703 20.5436 18.4031 20.2757 18.4031 20.0001V15.0001C18.4031 13.7289 17.9639 12.5603 17.2289 11.6377C17.7579 11.3584 18.3609 11.2002 19.0008 11.2002C21.0995 11.2002 22.8008 12.9015 22.8008 15.0002V19.0002C22.8008 19.9943 21.9949 20.8002 21.0008 20.8002H18.3085Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M6.77835 11.6395C6.04417 12.5617 5.60547 13.7297 5.60547 15.0001V20.0001C5.60547 20.2757 5.63826 20.5436 5.70014 20.8002H3.00313C2.00901 20.8002 1.20312 19.9943 1.20312 19.0002V15.0002C1.20312 12.9015 2.90444 11.2002 5.00312 11.2002C5.64436 11.2002 6.2485 11.359 6.77835 11.6395Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M12.0008 2.2002C9.9021 2.2002 8.20078 3.90151 8.20078 6.0002C8.20078 8.09888 9.9021 9.8002 12.0008 9.8002C14.0995 9.8002 15.8008 8.09888 15.8008 6.0002C15.8008 3.90151 14.0995 2.2002 12.0008 2.2002Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M5.00078 5.2002C3.73053 5.2002 2.70078 6.22994 2.70078 7.5002C2.70078 8.77045 3.73053 9.8002 5.00078 9.8002C6.27104 9.8002 7.30078 8.77045 7.30078 7.5002C7.30078 6.22994 6.27104 5.2002 5.00078 5.2002Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M19.0008 5.2002C17.7305 5.2002 16.7008 6.22994 16.7008 7.5002C16.7008 8.77045 17.7305 9.8002 19.0008 9.8002C20.271 9.8002 21.3008 8.77045 21.3008 7.5002C21.3008 6.22994 20.271 5.2002 19.0008 5.2002Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                            <path
                              d="M10.9984 11.2002C8.89976 11.2002 7.19844 12.9015 7.19844 15.0002V20.0002C7.19844 20.9943 8.00433 21.8002 8.99844 21.8002H14.9984C15.9926 21.8002 16.7984 20.9943 16.7984 20.0002V15.0002C16.7984 12.9015 15.0971 11.2002 12.9984 11.2002H10.9984Z"
                              fill="#D92027"
                              className="my-path"
                            ></path>
                          </svg>
                      ...
                      <Card.Text
                        ...
                        style={{ color: "#5b5b5b", marginTop: "20px", fontSize: "18px" }}
                      >
                        Guarantee that customers reach the first available agent without needing multiple numbers.
                      </Card.Text>
                    </Card.Body>
                  </Card>
                </Col>
                  ...
                  <div className="col d-flex justify-content-center">
                    <Card style={{ width: "100%", backgroundColor: "#D92027", border: "none" }}>
                      <Card.Body className="">
                        ...
                        >
                          <path
                            d="M10.9294 13.9106C10.9294 13.9106 10.9322 13.9093 10.9368 13.9086C10.9316 13.9106 10.9294 13.9106 10.9294 13.9106Z"
                            fill="#ffffff"
                            className="my-path"
                          ></path>
                          <path
                            d="M10.9565 13.9086C10.9611 13.9093 10.9639 13.9106 10.9639 13.9106C10.9639 13.9106 10.9617 13.9106 10.9565 13.9086Z"
                            fill="#ffffff"
                            className="my-path"
                          ></path>
                          <path
                  ...
                  <div className="col d-flex justify-content-center">
                    ...
                    >
                      <Card.Body>
                        ...
                        <Card.Title className="" style={{ color: "white" }}>
                          Flexible Mapping
                        </Card.Title>
                        <Card.Text className="" style={{ color: "white", marginTop: "20px" }}>
                          Link multiple numbers to one line providing flexible distribution of calls based on
                          availability.
                        </Card.Text>
                      </Card.Body>
                    </Card>
                  ...
                  <div className="col d-flex justify-content-center">
                    ...
                    >
                      <Card.Body>
                        ...
                        <Card.Text className="" style={{ color: "white", marginTop: "20px" }}>
                          Enhance your service with options like Interactive Voice Response, Call center Solutions, and
                          VirtualPBX.
                        </Card.Text>
                      </Card.Body>
                    </Card>
          ...
          <div id="pricing" style={{ marginBottom: "", paddingTop: "17%" }} className="container">
            ...
            <div className="d-flex justify-content-center" style={{ marginTop: "2%" }}>
              <div style={{ width: "auto", maxWidth: "620px" }}>
                <p style={{ textAlign: "center", fontSize: "18px", color: "#5b5b5b" }}>
                  Choose the right plan for your team with affordable rates and flexible options, so you're always
                  reachable
                </p>
              </div>
            </div>
            <div className="d-flex justify-content-center" style={{}}>
              <Button
                ...
                style={{ backgroundColor: "#000000CC", borderColor: "#000000CC" }}
                disabled
              >
                Annual Subscription
              </Button>
            ...
            <div className="" style={{ marginTop: "2%" }}>
              <Accordion style={{ paddingBottom: "2%", width: "auto", maxWidth: "1106px" }}>
                <Accordion.Item eventKey="0" style={{ border: "2px solid #D3D3D3" }}>
                  ...
                  <Accordion.Body>
                    Our return policy allows returns within 30 days of purchase, provided the item is in original
                    condition.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
