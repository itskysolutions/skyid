...
export const ScriptUpload = () => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      ...
      const validFileTypes = ['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document']; // Allow PDFs and DOCX
    ...
    <div className="flex flex-col items-center">
        {!file && (
            <label
                ...
                className="flex items-center px-4 py-2 bg-white text-[#D92027] border-2 border-solid border-[#D92027] rounded-lg cursor-pointer hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
            >
                <div className='me-2'>
      ...
      <input
        type="file"
        id="document-upload"
        accept=".pdf, .docx"  // Accept PDF and DOCX file types
