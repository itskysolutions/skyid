...
export const WalletTable = ({ Data }: TableProps) => {

  return (
    <div className="flex flex-col">
      <div className=" overflow-x-auto pb-4">
        <div className="block">
          <div className="overflow-x-auto w-full  border rounded-md border-gray-300">
                  ...
                  Data.map((item, index) => (
                    <tr key={index} className="bg-white transition-all duration-500 hover:bg-gray-50">
                      <td className="">
                        <div className="flex items-center  px-3 ">
                          <p className=" pt-4 text-left whitespace-nowrap text-sm leading-6 font-medium text-gray-900 capitalize">
                            {item.Ref_ID}
                          </p>
                        </div>
                    </td>
                    <td className="pt-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                      {item.Type}
                    </td>
                    <td className="pt-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                    ...
                    <td className=" ">
                      <div className="pt-4 flex items-center gap-3">
                        <div className="data">
                          <p className="font-normal text-sm text-gray-900">{item.Amount}</p>
                        </div>
                      </div>
                    </td>
                    <td className="pt-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
