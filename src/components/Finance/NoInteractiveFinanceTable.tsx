            ...
            <tbody className="divide-y divide-gray-300">
              {currentData.length > 0 ? (
                currentData.map((item, index) => (
                  <tr key={index} className="bg-white transition-all duration-300 hover:bg-gray-50">
                    <td className="py-3 px-4 text-sm text-gray-900 capitalize">{item.requestID}</td>
                    <td className="py-3 px-4 text-sm text-gray-900">{item.Date}</td>
                    <td className="py-3 px-4 text-sm text-gray-900">{item.userLevel}</td>
