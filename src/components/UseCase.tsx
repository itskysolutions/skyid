    ...
    const useCases = [
        {
            ...
            text: "Keep customer service seamless by ensuring that calls are always",
            more: "answered without exposing personal numbers."
        },
        {
            icon: (
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none"xmlns="http://www.w3.org/2000/svg">
            ...
            text: "Establish a professional identity with a single, unified phone number.",
            more: ""
        },
        {
            icon: (
            ...
            text: "Guarantee that customers reach the first available agent without needing",
            more:"multiple numbers."
        },
    ];
    ...
    return (
        <div>
             <div className="container justify-content-center" style={{ marginBottom: "100px" }}>
                <div className="text-center" style={{ marginTop: "60px", marginBottom: "50px", color: "#333333" }}>
                    <h1 className="font-anjaEliane" style={{ color: "#00000099" }}>Use Cases</h1>
                </div>
                <div>
                    <Row className="gy-4">
                        {useCases.map((useCase, index) => (
                            <Col key={index} className="custom-card" xs={12} md={4}>
                                <Card
                                    style={{
                                        height: "auto",
                                        maxHeight: "500px",
                                ...
                                >
                                    <Card.Body>
                                        ...
                                        >
                                            {useCase.text}
                                            {expanded[index] && <span className="ms-1">{useCase.more}</span>}
                                            <button
