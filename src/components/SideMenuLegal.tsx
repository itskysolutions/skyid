...
//                 <h4>Site Policy</h4>
//             </div>
//             <div className="flex-column mt-4 " style={{ width: '250px' }}>
//                     <Nav className="flex-column mt-4 nav nav-tabs vertical-tabs" style={{ width: '250px' }} role="tablist">
//                         <Nav.Item>
//                             <div style={{paddingBottom: '1%'}}>
//                                 <Nav.Link href="" role="tab" data-toggle="tab" aria-selected="true" onClick={handleToggleTos} aria-expanded={openTos} aria-controls="tos-submenu"  style={{
//                                     backgroundColor: openTos ? '#f0f0f0' : 'transparent', // Highlight when open
//                                     fontWeight: openTos ? 'bold' : 'normal', // Bold text when open
//                                     color: openTos ? '#D92027' : '#000', // Color change when open
//                                     borderColor: openTos ? '#D92027' : '#D92027',
//                                     //borderTopColor: '#D92027',
//                                 }}> Terms Of Service</Nav.Link>
//                                 <Collapse in={openTos}>
//                                     <div id="tos-submenu">
...
//                             </div>
//                             <div style={{paddingBottom: '1%'}}>
//                                 <Nav.Link href="/policies/#privacy" role="tab" data-toggle="tab" aria-selected="true" onClick={handleTogglePrivacy} aria-expanded={openPrivacy} aria-controls="" style={{
//                                     backgroundColor: openPrivacy ? '#f0f0f0' : 'transparent', // Highlight when open
//                                     fontWeight: openPrivacy ? 'bold' : 'normal', // Bold text when open
//                                     color: openPrivacy ? '#D92027' : '#000', // Color change when open
...
//                                             <Nav.Link href="/policies/#p-aci" role="tab" aria-controls="p-conditions">Automatically Collected Information</Nav.Link>
//                                         </Nav>
//                                     </div>
//                                 </Collapse>
//                             </div>
...
//                             </div>
//                             <div style={{paddingBottom: '1%'}}>
//                                 <Nav.Link href="/policies/#cookie" role="tab" data-toggle="tab" aria-controls="cookie" aria-selected="true" onClick={handleToggleCookie} aria-expanded={openCookie}  style={{
//                                     backgroundColor: openCookie ? '#f0f0f0' : 'transparent', // Highlight when open
//                                     fontWeight: openCookie ? 'bold' : 'normal', // Bold text when open
//                                     color: openCookie ? '#D92027' : '#000', // Color change when open
