    ...
    return (
        <div>
            <div className="d-flex flex-column align-items-center justify-content-center">
                ...
                <div style={{ paddingBottom: '3%', paddingRight:'34%' }}><h4><b>Add Ons</b></h4> </div>
                <div style={{ paddingRight:'39%' }}><p>Select</p></div>
            </div>
            <div style={{ paddingLeft:'29%' }}> 
                <div>
                    <div className={`mb-4 p-2 rounded-md ${ selected === 'option1' ? 'bg-[#E8F1FF]' : 'bg-white'} w-[50%]`}>
                        <input
                            type="checkbox"
                            id="featureCheckbox1"
                    ...
                    <div className={`mb-4 p-2 rounded-md ${ selected === 'option2' ? 'bg-[#E8F1FF]' : 'bg-white'} w-[50%]`}>
                        <input
                            type="checkbox"
                            id="featureCheckbox2"
                    ...
                    <div style={{display:"flex", paddingTop:"2%"}}> 
                        ...
                        <p style={{color:"#00000080"}}>After completing payment you can manage your IVR & IVM through <br/> the Add Ons tab on your dashboard</p>
                    </div>
                </div>
            </div>
            <div className="mt-[40px]" style={{ paddingLeft:'29%' }}><CustomButton name="Skip Add Ons for now" backgroundColor="bg-[#ffffff]" textColor="text-[#D92027]" style="w-[500px]" border="border-2 solid border-[#D92027]" /></div>
            <div className="mt-[20px]" style={{ paddingLeft:'29%' }}><CustomButton name="Proceed to CheckOut" backgroundColor="bg-[#D92027]" textColor="text-[#ffffff]" style="w-[500px]" /></div>
        </div>
    )
