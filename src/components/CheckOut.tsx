  ...
  return (
    <div className="container" style={{ maxWidth: "500px" }}>
      <div className="w-full">
        <div className="pb-2">
          <NavLink
            to="/app/buyNumber/dashboardAddOns"
            className="no-underline"
            style={{ color: "#D92027", display: "flex", fontSize: "18px" }}
          >
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-chevron-left mt-1 me-2"
              viewBox="0 0 16 16"
            >
              <path
                fill-rule="evenodd"
        ...
        <p>Sky ID Number</p>
        <p className="mt-3" style={{ color: "#00000099" }}>
          07003100410
        </p>
        <hr />
        <p>Mapped Number</p>
        ...
        <div style={{ display: "flex", paddingTop: "2%" }}>
          ...
          <p style={{ color: "#00000080", fontSize: "14px" }}>
            Additional mapping cost ₦15,000 for each number added per year
          </p>
        </div>
        <div className="flex justify-between">
